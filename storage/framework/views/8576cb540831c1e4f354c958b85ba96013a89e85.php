                    ...
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                ...
                                <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo e($guru); ?></div>
                            </div>
                            <div class="col-auto">
                    ...
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                ...
                                <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo e($kelas); ?></div>
                            </div>
                            <div class="col-auto">
                        ...
                        <div class="card shadow mb-4">
                            ...
                            <div class="card-body">
                                <h4 class="small font-weight-bold">Server Migration
                                    <span class="float-right"><?php echo e($percentSiswa); ?>%</span>
                                </h4>
                                ...
                                <h4 class="small font-weight-bold">Sales Tracking 
                                    <span class="float-right"><?php echo e($percentGuru); ?>%</span>
                                </h4>
                                <div class="progress mb-4">
                                ...
                                <h4 class="small font-weight-bold">Customer Database 
                                    <span class="float-right"><?php echo e($percentKelas); ?>%</span>
                                </h4>
                                <div class="progress mb-4">
                            ...
                            <div class="card-body">
                                <div class="text-center">
                                    <img class="img-fluid px-3 px-sm-4 mt-3 mb-4" style="width: 25rem;"
                                        src="<?php echo e(URL::asset('template/img/undraw_posting_photo.svg')); ?>" alt="">
                                </div>
...
<?php echo $__env->make('layouts/app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\code\uji-level\4\resources\views/index.blade.php ENDPATH**/ ?>