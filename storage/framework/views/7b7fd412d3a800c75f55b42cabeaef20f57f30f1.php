...
<head>
    ...
    <title><?php echo $__env->yieldContent('title_web'); ?></title>
    ...
    <link href="<?php echo e(URL::asset('template/vendor/fontawesome-free/css/all.min.css')); ?>" rel="stylesheet" type="text/css">
    
    <link href="<?php echo e(URL::asset('template/css/sb-admin-2.min.css')); ?>" rel="stylesheet" type="text/css">
</head>
<body id="page-top">
    <div id="wrapper">
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <div id="collapseOne" class="collapse"  data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item <?php echo e(request()->is('guru') ? 'active' : ''); ?>" 
                            href="<?php echo e(url('/guru')); ?>">Guru</a>
                        <a class="collapse-item <?php echo e(request()->is('kelas') ? 'active' : ''); ?>" 
                            href="<?php echo e(url('/kelas')); ?>">Kelas</a>
                        <a class="collapse-item <?php echo e(request()->is('siswa') ? 'active' : ''); ?>" 
                            href="<?php echo e(url('/siswa')); ?>">Siswa</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse"  data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item <?php echo e(request()->is('mapel') ? 'active' : ''); ?>" 
                            href="<?php echo e(url('/mapel')); ?>">
                            Mata Pelajaran
                        </a>
                        <a class="collapse-item <?php echo e(request()->is('kompetensidasar') ? 'active' : ''); ?>" 
                            href="<?php echo e(url('/kompetensidasar')); ?>">
                            Kompetensi Dasar
                        </a>
                        <a class="collapse-item <?php echo e(request()->is('kegiatan') ? 'active' : ''); ?>" 
                            href="<?php echo e(url('/kegiatan')); ?>">
                            Kegiatan
                        </a>
                        <a class="collapse-item <?php echo e(request()->is('rpp') ? 'active' : ''); ?>" 
                            href="<?php echo e(url('/rpp')); ?>">
                            RPP
                        </a>
                    </div>
                </div>
            ...
            <li class="nav-item">
                ...
                <div id="collapseThree" class="collapse"  data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item <?php echo e(request()->is('kategoripenilaian') ? 'active' : ''); ?>" 
                            href="<?php echo e(url('/kategoripenilaian')); ?>">Kategori Penilaian</a>
                    </div>
                </div>
            </li>
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <img class="img-profile rounded-circle"
                                    src="<?php echo e(URL::asset('template/img/undraw_profile.svg')); ?>">
                            </a>
    ...
    <script src="<?php echo e(URL::asset('template/js/sb-admin-2.min.js')); ?>"></script>
    ...
    <script src="<?php echo e(URL::asset('template/js/demo/chart-pie-demo.js')); ?>"></script>
...
</html><?php /**PATH D:\code\uji-level\4\resources\views/layouts/appAdmin.blade.php ENDPATH**/ ?>