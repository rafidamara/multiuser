            ...
            <li class="nav-item">
                ...
                <div id="collapseOne" class="collapse"  data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item <?php echo e(request()->is('blog') ? 'active' : ''); ?>" 
                            href="<?php echo e(url('/blog')); ?>">Blog</a>
                    </div>
                </div>
            </li>
...
</html><?php /**PATH D:\4_u\resources\views/layouts/appAdmin.blade.php ENDPATH**/ ?>